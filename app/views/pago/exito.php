...
<head>
    ...
    <title>Pago Exitoso - <?= htmlspecialchars($siteName) ?></title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <p class="text-gray-600 mb-6">Tu pago ha sido procesado correctamente. Recibirás un correo de confirmación.</p>
            <div class="bg-green-50 rounded-lg p-4 mb-6">
                <p class="text-green-700">Gracias por tu pago. Tu cuenta ha sido actualizada.</p>
            </div>
